...
export default {
  pages: {
    ...
    data: [
      ...
      { title: 'Checkout', route: { name: 'shop-products-checkout' }, icon: 'DollarSignIcon', isBookmarked: false },
      ...
      { title: 'Product Details', route: { name: 'shop-product-details', params: { slug: 'apple-watch-series-5-27' } }, icon: 'BoxIcon', isBookmarked: false, },
      ...
      { title: 'Shop', route: { name: 'shop-products-shop' }, icon: 'ArchiveIcon', isBookmarked: false },
      ...
      { title: 'Wishlist', route: { name: 'shop-products-wishlist' }, icon: 'HeartIcon', isBookmarked: false },
    ],
  },
  files: {
    key: 'file_name',
