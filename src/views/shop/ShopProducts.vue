    ...
    <section :class="itemView">
      ...
      >
        ...
        <div class="item-options text-center">
          ...
          <b-button variant="outline-primary" tag="a" class="btn-edit">
            <!-- @click="toggleProductInWishlist(product)" -->

            <feather-icon icon="EditIcon" class="mr-50 text-primary" />
            <span>Edit</span>
          </b-button>
          <b-button variant="danger" tag="a" class="btn-delete">
...
import {
  ...
  useShopUi,
  useShopRemoteData,
} from "./useECommerceShop.js";
import { useEcommerceUi } from "./useEcommerce.js";
