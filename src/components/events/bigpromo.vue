<template>
  <div>
    <transition name="fade">
      <div class="boostshopBloc" v-if="bigpromo_s">
        <div class="titleEvents">Big Promo</div>
        <div class="header">
        ...
        <transition name="fade">
          <div class="body" v-if="step == 1">
            <h2>Increase your sales chances</h2>
            <p style="margin-top: 12px">
              Big Promo will increase your chances to sell on Afeshop by doing a
              target advertising directly in our main slideshow
            </p>
        ...
        <transition name="fade">
          <div class="body" v-if="step == 2">
            ...
            <p style="margin-top: 30px; font-size: 18px">
              You have subscribe for a Promotion from 12/12/2020 to 28/12/2020 ,
              <br />
        ...
        <div class="footer_boosthop">
          <div class="cancel" @click="closebigpromo()">Cancel</div>
...
export default {
  ...
  methods: {
    ...
    closebigpromo: function () {
      this.$emit("closebigpromo");
    },
  },
};
</script>
